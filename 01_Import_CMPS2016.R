...
cmps.sub.2016 <- da38040.0001 %>% dplyr::select(S2_1, S2_2, S2_3, S2_4,S2_5, S2_6, S2_7, S4,
                                                ...
                                                C253, LA202_6, S1, L24, C262, C337,
                                                SPLITC337, SPLITC141, C141, BLA205, 
                                                SPLITC38)
...
latino.pop.data_16 <- read.csv("/Users/jenniferlopez/Desktop/COIi work/Latino_Belonging/latino_pop.csv") %>% mutate(State = NAME,
                                                            State = state.abb[match(State, state.name)]) %>% 
